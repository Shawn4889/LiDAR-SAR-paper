...
a_HV=-22.6740453337829;
b_HV=-14.407851839904;
c_HV=4.0500908616841;
a_HH=-15.0409859457326;
b_HH=-9.04423820385341;
c_HH=3.89574296632479;
...
t = fullfile('E:\ChangMap\CHM\DB_20210905\DB_SAR_pred\Prediction_wcm\cover\',suf_hv);
%figure;
%imagesc(geotiff1);
